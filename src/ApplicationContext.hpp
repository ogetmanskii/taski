...
namespace {
    ...
    std::unordered_map<std::string, std::shared_ptr<Service>> BuildNameToServiceMap(const std::vector<std::shared_ptr<Service>>& services) {
    ...
    std::unordered_map<std::string, std::shared_ptr<Task>> BuildNameToTaskMap(const std::vector<std::shared_ptr<Task>>& tasks) {
